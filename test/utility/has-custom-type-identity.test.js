...
describe(
  '`hasCustomTypeIdentity` - does approve whether the passed value features a custom applied type-identity,' +
    ' which is ... there are `Symbol.toStringTag` related slots available, directly owned either by the passed' +
    ' value itself or by its prototype, and none of it can be matched against a built-in type-identity.',
  () => {
