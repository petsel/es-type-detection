...
Defined in: [src/index.js:83](https://github.com/petsel/es-type-detection/blob/92dfb41aaf7622d4972dbde1d89cebef8471f4d7/src/index.js#L83)
...
> **isAnyGenerator**: (`value?`) => `value is any`
...
> **isAsyncGenerator**: (`value?`) => `value is any`
...
> **isGenerator**: (`value?`) => `value is any`
...
#### utility.defineStableTypeIdentity()
...
> **getDefinedConstructor**: (`value?`) => `CallableFunction` \| `NewableFunction` \| [`ES3Function`](../../function/type-aliases/ES3Function.md) \| [`ClassConstructor`](../../utility/type-aliases/ClassConstructor.md)
...
`CallableFunction` \| `NewableFunction` \| [`ES3Function`](../../function/type-aliases/ES3Function.md) \| [`ClassConstructor`](../../utility/type-aliases/ClassConstructor.md)
...
#### utility.hasBuiltinTypeIdentity()
